...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 padding: 0'><span style="text-transform:uppercase">Olvidaste</span></h1>
 ...
 padding: 0'><span style="text-transform:uppercase">tu contraseña?</span></h2>
 ...
 color: #2a2a2a; font-family: "Asap", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: center; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">!No te preocupes, te tenemos la solución! Dale click al botón "Reset Password"
                                <br></br>
                              </td>
                              
                            </tr>
                            <tr>
                               <td style= 'text-align: center; padding-top:9px; padding-right: 18px;
                                          padding-bottom: 9px; padding-left: 18px;' valign="top">

                                <input id="emailInput" placeholder="Digite su número de celular  +51 XXX XXX XXX" class="form-control" type="email" oninvalid="setCustomValidity('Please enter a valid cellphone!')" onchange="try{setCustomValidity('')}catch(e){}" required="">
                               </td>
 ...
 0; text-align: left; width: 100%; font-size: 16px; font-weight: bold; '>Soporte técnico</h3>
 ...
 text-align: left; text-align: left; font-size: 14px; '> Comuniquese con nuestro equipo de ayuda especializado a través de este número 333 333 o al correo support01@gmail.com.
                              </p>
                            </td>
                          </tr>
                        </table>
 ...
 Helvetica, sans-serif; font-size: 12px;" valign="top">
                                <div style="text-align: center;">Hecho con
 ...
 text-decoration: none; width: 10px; height: 10px; margin: 0px;" width="10" />
                                  ...
                                  <a href="http://sumweb.com.pe/web/clientes.php" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #f57153;
 font-weight: normal; text-decoration: none; color:#7F6925;" target="_blank" title="Noun Project - Icons for Everything">Soft3.0 </a>in Lima, Perú</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
